...
[^2]: <https://github.com/ju1-eu/N-Betriebsfuehrung.git>
...
```
# HTTPS oder SSH
HTTPS: https://github.com/ju1-eu/N-Betriebsfuehrung.git
SSH: git@github.com:ju1-eu/N-Betriebsfuehrung.git
...
git remote add origin https://github.com/ju1-eu/N-Betriebsfuehrung.git
...
```
git clone https://github.com/ju1-eu/N-Betriebsfuehrung.git
```
